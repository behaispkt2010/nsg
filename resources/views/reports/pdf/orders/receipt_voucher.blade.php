        ...
        <div class="tracking">
            <div class="col-md-12" style="color: #000;">
                <div class="col-md-12 col-sm-12 col-xs-12 text-center ">
                    <h3 class="uppercase" style="text-align: center;"><strong>Phiếu thu</strong></h3>
                    ...
                    <div class="">
                        ...
                        <div class="col-xs-12 col-md-12 col-sm-12 text-left">
                            ...
                            <p><strong>Lý do nộp: </strong></p><br>
            ...
            <div class="row">
                ...
                <div class="col-xs-3">
                    <h4 class="uppercase text-center bold">Người nộp tiền</h4>
                    <p class="text-center">(Ký và ghi rõ họ tên)</p>
                </div>
                <div class="col-xs-3">
