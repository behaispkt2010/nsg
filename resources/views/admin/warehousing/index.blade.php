...
<div class="hover-new-btn h-hover">
    <div class="h-report">
        <a href="{{route('warehousing.create', ['cate' => 'issue'])}}" class="btn btn-success btn-fab" title="Tạo phiếu xuất">
    ...
    <div class="h-plus">
        <a href="{{route('warehousing.create', ['cate' => 'receipt'])}}" class="btn btn-warning btn-fab" title="Tạo phiếu nhập">
            <i class="material-icons iconPlus">add</i>
                ...
                <div class="x_content">
                    <div class="row">
                                        ...
                                        <ul class="list-unstyled">
                                            ...
                                            <li class="limitcharacter"><span class="label-box1">Trạng thái</span>
                                                <strong>
                                                    ...
                                                    Mới tạo
                                                    @elseif($warehousing->status == 1)
                                                    Đang xử lý
                                                    @elseif($warehousing->status == 2)
                                                    Hoàn thành
                                                    @elseif($warehousing->status == 3)
                                                    Hủy
                                                    @endif
                                                </strong>
                                            </li>
                                            <li class="limitcharacter"><span class="label-box1">Người tạo:</span>{{ \App\NewsCompany::getUserName($warehousing->author_id) }}</li>
                                            <li class="limitcharacter"><span class="label-box1">Thời gian:</span><?php echo (date_format($warehousing->created_at ,"d/m/Y - H:i:s")) ?></li>
                                        </ul>
                                    </div>
                                </div>

                                <div class="col-xs-12 text-center">
                                    <a href="{{route('warehousing.edit',['id' => $warehousing->id])}}" class="btn btn-raised btn-primary btn-xs">
                                        <i class="fa fa-pencil" aria-hidden="true" ></i> Sửa
                                    </a>
                                    <form action="{{route('warehousing.destroy',['id' => $warehousing->id])}}" method="post" class="form-delete" style="display: inline">
                                        <input type="hidden" name="_token" value="{{csrf_token()}}">
                                        <input type="text" class="hidden" value="{{$warehousing->id}}">
                                        {{method_field("DELETE")}}
                        ...
                        <div class="text-center">
                            {{ $warehousings->appends(array('name' => Request::get('name'),'dateview' => Request::get('dateview')))->links() }}
                        </div>
                        @else
